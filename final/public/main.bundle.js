...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_product_list_product_list_component__ = __webpack_require__("../../../../../src/app/components/product-list/product-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_search_filter_search_filter_pipe__ = __webpack_require__("../../../../../src/app/components/search-filter/search-filter.pipe.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__components_product_list_product_list_component__["a" /* ProductListComponent */],
                __WEBPACK_IMPORTED_MODULE_17__components_search_filter_search_filter_pipe__["a" /* SearchFilterPipe */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    { path: 'navbar', component: __WEBPACK_IMPORTED_MODULE_4__components_navbar_navbar_component__["a" /* NavbarComponent */] },
                    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_5__components_login_login_component__["a" /* LoginComponent */] },
                    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_7__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */]] },
                    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_9__components_register_register_component__["a" /* RegisterComponent */] },
                    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_14__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */]] },
                    { path: 'productList', component: __WEBPACK_IMPORTED_MODULE_16__components_product_list_product_list_component__["a" /* ProductListComponent */] },
                    { path: 'search', component: __WEBPACK_IMPORTED_MODULE_19__components_search_search_component__["a" /* SearchComponent */] }
                ]),
                __WEBPACK_IMPORTED_MODULE_11_angular2_flash_messages__["FlashMessagesModule"]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_10__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_18__services_data_service__["a" /* DataService */]],
...
module.exports = "<main role=\"main\">\n\n  <section class=\"jumbotron text-center\">\n    <div class=\"container\">\n      <h1 class=\"jumbotron-heading\">Big Hammer Black Friday</h1>\n      <img src=\"https://ir.ebaystatic.com/rtm/0/RTMS/Image/5626_112017_PEAKH_BFWeekDeals_DDTopBanner_1200x100_FINAL123.jpg\" style=\"width: 100%\">\n      <p class=\"lead text-muted\">Big Hammer promises you the lowest price with perfect quality. What are you waiting for? Start shopping now!</p>\n      <a href=\"#\" class=\"btn btn-primary\" [routerLink]=\"['/productList']\" (click)=\"doSearch()\">Show now</a>\n    </div>\n  </section>\n\n\n</main>\n"
...
module.exports = "<h2 class=\"page-header\" style=\"text-align: center\">LOGIN</h2>\n<form (submit)=\"onLoginSubmit()\">\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" class=\"form-control\" name=\"username\" placeholder=\"Enter username\" [(ngModel)]=\"username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputPassword1\">Password</label>\n    <input type=\"password\" class=\"form-control\" name=\"password\" id=\"exampleInputPassword1\" placeholder=\"Enter password\" [(ngModel)]=\"password\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show('Logged in successfully!', { cssClass: 'alert-success', timeout: 6000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessagesService.show(data.msg, { cssClass: 'alert-danger', timeout: 6000 });
...
module.exports = "<div class=\"container\">\n  <nav class=\"navbar navbar-expand-md navbar-dark bg-dark fixed-top\">\n<a class=\"navbar-brand\" href=\"#\">BigHammer</a>\n<div class=\"collapse navbar-collapse\" id=\"navbarsExampleDefault\">\n  <ul class=\"navbar-nav mr-auto\">\n    <li class=\"nav-item active\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n      <a class=\"nav-link\" [routerLink]=\"['/']\">Home</a>\n    </li>\n    <li class=\"nav-item dropdown\">\n      <a class=\"nav-link dropdown-toggle\" href=\"http://example.com\" id=\"dropdown01\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Sort</a>\n      <div class=\"dropdown-menu\" aria-labelledby=\"dropdown01\">\n        <a class=\"dropdown-item\" href=\"#\">Price -low to high</a>\n        <a class=\"dropdown-item\" href=\"#\">Price -high to low</a>\n        <a class=\"dropdown-item\" href=\"#\">Rating</a>\n        <a class=\"dropdown-item\" href=\"#\">Name</a>\n      </div>\n    </li>\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/Cart']\">View Cart</a>\n    </li>\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/Bookmark']\">View Bookmark</a>\n    </li>\n  </ul>\n  <ul class=\"nav navbar-nav\">\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/dashboard']\">DASHBOARD</a>\n    </li>\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/profile']\">PROFILE</a>\n    </li>\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n      <a class=\"nav-link\" [routerLink]=\"['/register']\" *ngIf=\"!authService.loggedIn()\">REGISTER</a>\n    </li>\n    <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\" *ngIf=\"!authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/login']\" >LOGIN</a>\n    </li>\n    <li class=\"nav-item\">\n      <a class=\"nav-link\" (click)=\"onLogoutClick()\" href=\"#\" *ngIf=\"authService.loggedIn()\">LOGOUT</a>\n    </li>\n  </ul>\n  <form class=\"form-inline my-2 my-lg-0\">\n    <input class=\"form-control mr-sm-2\" type=\"text\" placeholder=\"Search\" aria-label=\"Search\" [(ngModel)]=\"search\" name=\"search\">\n    <button class=\"btn btn-outline-success my-2 my-sm-0\" type=\"submit\" [routerLink]=\"['/search']\"  (click)=\"doSearch()\">Search</button>\n  </form>\n</div>\n</nav>\n</div>\n"
...
var NavbarComponent = (function () {
    function NavbarComponent(authService, router, flashMessagesService, dataService) {
        this.authService = authService;
        this.router = router;
        this.flashMessagesService = flashMessagesService;
    ...
    NavbarComponent.prototype.doSearch = function () {
...
var ProductListComponent = (function () {
    ...
    ProductListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.productsService.getProductList().subscribe(function (res) { return _this.products = res; });
    };
    ProductListComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-product-list',
            template: __webpack_require__("../../../../../src/app/components/product-list/product-list.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/product-list/product-list.component.css")],
            providers: [__WEBPACK_IMPORTED_MODULE_1__services_products_service__["a" /* ProductsService */]]
        }),
...
module.exports = "<h2 class=\"page-header\" style=\"text-align: center\">Register</h2>\n\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label>Name</label>\n    <input type=\"text\" class=\"form-control\" name=\"name\" placeholder=\"Enter name\" [(ngModel)]=\"name\">\n  </div>\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" class=\"form-control\" name=\"username\" placeholder=\"Enter username\" [(ngModel)]=\"username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputPassword1\">Password</label>\n    <input type=\"password\" class=\"form-control\" name=\"password\" id=\"exampleInputPassword1\" placeholder=\"Enter password\" [(ngModel)]=\"password\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputEmail1\">Email address</label>\n    <input type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" name=\"email\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\" [(ngModel)]=\"email\">\n    <small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small>\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Confirm</button>\n</form>\n"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessageService.show('Registered successfully!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessageService.show('Something unexpected happened.', { cssClass: 'alert-danger', timeout: 3000 });
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__["FlashMessagesService"], __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */]])
    ], RegisterComponent);
...
/***/ "../../../../../src/app/components/search-filter/search-filter.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SearchFilterPipe = (function () {
    ...
    SearchFilterPipe.prototype.transform = function (products, search) {
        if (search === undefined) {
...
module.exports = "<div class=\"album text-muted\">\n  <div class=\"container\">\n    <ul>\n      <li *ngFor=\"let product of products|searchFilter:search\">\n        <div class=\"row\">\n          <div class=\"card\">\n            <img data-src=\"{{product.image}}\" alt=\"Card image cap\" style=\"width: 300px;height: 250px\">\n            <h3><a>{{product.name}}</a></h3>\n            <h4>Price: {{product.price}}</h4>\n            <p>Location: {{product.location}}</p>\n            <p class=\"card-text\">Description: {{product.description}}</p>\n          </div>\n        </div>\n      </li>\n    </ul>\n\n\n  </div>\n</div>\n"
...
var SearchComponent = (function () {
    function SearchComponent(productsService, dataService) {
        this.productsService = productsService;
        this.dataService = dataService;
    }
    SearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.currentMessage.subscribe(function (mes) {
            _this.search = mes;
        });
        this.productsService.getProductList().subscribe(function (res) { return _this.products = res; });
    };
    SearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_products_service__["a" /* ProductsService */], __WEBPACK_IMPORTED_MODULE_2__services_data_service__["a" /* DataService */]])
    ], SearchComponent);
...
var DataService = (function () {
    function DataService() {
        this.message = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]("default message");
...
var ProductsService = (function () {
    ...
    ProductsService.prototype.getProductList = function () {
        ...
        headers.append('Content-Ytpe', 'application/json');
        return this.http.get('http://localhost:3000/products').map(function (res) { return res.json(); });
    };
